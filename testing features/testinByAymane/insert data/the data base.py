...
# TABLE : student
mycursor.execute("create table if not exists student (id_student int primary key auto_increment,firstname varchar(45),lastname varchar(45),CIN varchar(45),CNE varchar(45),gender varchar(45),birthday date,image longBlob)")
# TABLE : bac_student
