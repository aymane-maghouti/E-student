...
# TABLE : publication
mycursor.execute(
    "create table if not exists publication(id_publication int primary key auto_increment,type varchar(45),description varchar(200),file longblob,date_pub datetime)")
# TABLE : prof
mycursor.execute(
