...
data_student_btn = tk.Button(options_frame, text='data std', font=('bold', 15),
                             ...
                             command=lambda: indicate(data_student_indicate, data_student_page))
...
delete_std_btn = tk.Button(options_frame, text='delete std', font=('bold', 15),
                           fg='#158aff', bd=0, bg='#c3c3c3',
                           command=lambda: indicate(delete_std_indicate, delete_std_page))
...
change_data_btn = tk.Button(options_frame, text='Chge data', font=('bold', 15),
                            fg='#158aff', bd=0, bg='#c3c3c3',
                            command=lambda: indicate(change_data_indicate, change_Data_page))
...
publicate_data_btn = tk.Button(options_frame, text='pbl data', font=('bold', 15),
                               fg='#158aff', bd=0, bg='#c3c3c3',
                               command=lambda: indicate(publicate_data_indicate, publication_page))
