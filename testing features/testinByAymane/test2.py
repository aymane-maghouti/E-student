...
l = [['avis', '2023-04-24 23:54:45', 'ashauschc\ndsdvsvv\nds\n'],
     ['Avis aux élèves ingénhhhhhhhhhhhhhhhhhhhhhhhhhhhhhieursssssssssssssssss ID1', '2023-04-02 13:12:34',
      'Il est porté à la connaissance des élèves ingénieurs de la première année Ingénieurie des données (ID1) que leDS du module Data Mining aura lieu le Jeudi 12/04/2023 à 09h00 à l’amphi A.']]
show(l)
