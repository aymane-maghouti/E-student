...
class StudentStaff:
    ...
    def show_prof(self):
        ...
        Label(self.table, text="First name",font=("Montserrat", 15, "bold"),foreground="#bb86fc",background="#1f1a24", width=10, height=2).grid(row=0, column=0)
        Label(self.table, text="Last name",font=("Montserrat", 15, "bold"),foreground="#bb86fc",background="#1f1a24", width=15, height=2).grid(row=0, column=1)
        Label(self.table, text="Email ",font=("Montserrat", 15, "bold"),foreground="#bb86fc",background="#1f1a24", width=20, height=2).grid(row=0, column=2)
        i=0
        for row in result:
            Label(self.table, text=row[0],font=("Montserrat", 10),foreground="white",background="#1f1a24", width=20, height=2).grid(row=i + 1, column=0)
            Label(self.table, text=row[1],font=("Montserrat", 10),foreground="white",background="#1f1a24", width=25, height=2).grid(row=i + 1, column=1)
            Label(self.table, text=row[2],font=("Montserrat", 10),foreground="white",background="#1f1a24", width=36, height=2).grid(row=i + 1, column=2)
            i+=1
