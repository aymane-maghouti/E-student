...
class Forgot:
    ...
    def createForgot(self, base):
        ...
        base.emailForgotStandardObject = MyEntry(base.Background, 94, 254, entry=base.emailForgotEntry,
                                                 ...
                                                 placeholder="fname.lname@etu.uae.ac.ma",
        ...
        base.pconfirmForgotStandardObject.validate = lambda: checkPassword(base.passwordForgotEntry.get(),
                                                                           base.confirmForgotEntry.get())

        base.forgotForm = MyForm(base, base.emailForgotStandardObject, base.passwordForgotStandardObject,
                                 base.pconfirmForgotStandardObject)
        ...
        base.forgotGroup = MyWidgetsGroup(base.Background, base.ForgotWidgetsFrame, base.emailForgotText,
                                          base.passwordForgotText, base.confirmForgotText,
                                          base.emailForgotStandardObject, base.passwordForgotStandardObject,
                                          base.pconfirmForgotStandardObject, base.ForgotTitle)
