...
class StudentAbout:
    ...
    def createStudentAbout(self, base):
        ...
        base.studentAboutImg = ImageTk.PhotoImage(Image.open(
            base.resourcePath("assets/studentAboutPage/aboutBackground.png")))

        base.studentAboutFrame = MyScrollableFrame(base.Background, base.studentAboutImg, "#1f1a24", 685, 297, 117, 174,
                                                   20, 20)

        # Technical
        base.studentAboutTechnicalText = Label(base.studentAboutFrame.scrollable_frame, text="Technical Informations :",
        ...
        base.Technical = Text(base.studentAboutFrame.scrollable_frame, width=Technical_width, height=num_lines,
        ...
        # materials
        base.studentMaterialsText = Label(base.studentAboutFrame.scrollable_frame, text="About Materials :",
                                          font=("Montserrat", 10, "bold"),
                                          relief="flat", foreground="#bb86fc", background="#1f1a24")
        ...
        base.Materials = Text(base.studentAboutFrame.scrollable_frame, width=Materials_width, height=num_lines,
                              takefocus=False, font=("Montserrat", 10, "bold"),
                              relief="flat", foreground="white", background="#1f1a24")
        ...
        # developers
        base.studentdevelopersText = Label(base.studentAboutFrame.scrollable_frame, text="About Developers :",
                                           font=("Montserrat", 10, "bold"),
                                           relief="flat", foreground="#bb86fc", background="#1f1a24")
        ...
        base.developers = Text(base.studentAboutFrame.scrollable_frame, width=developers_width, height=num_lines,
                               takefocus=False, font=("Montserrat", 10, "bold"),
                               relief="flat", foreground="white", background="#1f1a24")
        ...
        # App
        base.studentAppText = Label(base.studentAboutFrame.scrollable_frame, text="App :",
                                    font=("Montserrat", 10, "bold"),
                                    relief="flat", foreground="#bb86fc", background="#1f1a24")
        ...
        base.App = Text(base.studentAboutFrame.scrollable_frame, width=App_width, height=num_lines, takefocus=False,
                        font=("Montserrat", 10, "bold"),
                        relief="flat", foreground="white", background="#1f1a24")
