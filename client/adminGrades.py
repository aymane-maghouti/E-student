...
class AdminGrades:
    ...
    def createAdminGrades(self, base):
        ...
        base.adminGradesClassList = MyMenu(base.Background, 250, 223, base.adminGradesClassLabel,
                                           ...
                                           base.menuAdminGradesClassMidHoverImg,
                                           base.menuAdminGradesClassMidClickedImg,
                                           base.menuListAdminGradesClassMidStandardImg,
        ...
        base.importAdminGradesButton = MyButton(base.Background, 250, 360, standardImg=base.importAdminGradesButtonImg,
                                                clickImg=base.importAdminGradesClickedButtonImg,
        ...
        base.adminGradesForm = MyForm(base, base.adminGradesClassList, base.moduleAdminGradesStandardObject,
                                      base.importAdminGradesButton)
        ...
        base.submitAdminGradesButton = MyButton(base.Background, 350, 431, standardImg=base.submitAdminGradesButtonImg,
                                                clickImg=base.submitAdminGradesHoverButtonImg,
