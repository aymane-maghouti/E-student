...
class AdminTimeTable:
    ...
    def createAdminTimeTable(self, base):
        ...
        base.adminTimeTableClassList = MyMenu(base.Background, 250, 223, base.adminTimeTableClassLabel,
                                            base.menuAdminTimeTableClassMidStandardlImg, base.menuAdminTimeTableClassMidHoverImg,
                                            base.menuAdminTimeTableClassMidClickedImg, base.menuListAdminTimeTableClassMidStandardImg,
                                            menuListMarginY=35,
        ...
        base.adminTimeTableGroup=MyWidgetsGroup(base.Background,base.adminTimeTableTitle,base.adminTimeTableClassText,base.adminTimeTableFrame,base.adminTimeTableClassLabel,base.adminTimeTableClassList)
