...
class Login:
    ...
    def createLogin(self, base):
        ...
        base.Background.signup = MyButton(base.Background, 221, 212, base.signupStandardlImg,
                                          hoverImg=base.signupHoverImg, cursor="hand2", behavior=base.loginToRegister1)
        ...
        base.Background.forgot = MyButton(base.Background, 219, 375, base.forgotStandardlImg,
                                          hoverImg=base.forgotHoverImg, cursor="hand2", behavior=base.loginToForgot)

        base.notMember = base.Background.create_text(130, 210, text="not a member ?", font=("Montserrat", 7),
                                                     fill="white",
                                                     anchor=tk.NW)
        ...
        base.emailLoginText = base.Background.create_text(115, 241, text="Email address",
        ...
        base.emailLogingStandardObject = MyEntry(base.Background, 94, 254, entry=base.emailLogingEntry,
                                                 ...
                                                 placeholder="first.last@etu.uae.ac.ma", modified=self.emailModified,
                                                 value=self.emailVar)
