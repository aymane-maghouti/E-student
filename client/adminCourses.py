...
class AdminCourses:
    ...
    def createAdminCourses(self, base):
        ...
        base.moduleAdminCoursesText = base.Background.create_text(270, 278, text="Title",
        ...
        base.adminCoursesClassList = MyMenu(base.Background, 250, 223, base.adminCoursesClassLabel,
                                            ...
                                            base.menuAdminCoursesClassMidHoverImg,
                                            base.menuAdminCoursesClassMidClickedImg,
                                            base.menuListAdminCoursesClassMidStandardImg,
        ...
        # import
        base.moduleAdminCoursesFileText = base.Background.create_text(270, 349, text="file",
                                                                      font=("Montserrat", 6, "bold"),
                                                                      fill="#bb86fc", anchor=tk.NW)
        ...
        base.importAdminCoursesButton = MyButton(base.Background, 250, 360,
                                                 standardImg=base.importAdminCoursesButtonImg,
                                                 clickImg=base.importAdminCoursesClickedButtonImg,
        ...
        base.adminCoursesForm = MyForm(base, base.adminCoursesTypeList, base.adminCoursesClassList,
                                       base.moduleAdminCoursesStandardObject, base.importAdminCoursesButton)
        ...
        base.submitAdminCoursesButton = MyButton(base.Background, 350, 431,
                                                 standardImg=base.submitAdminCoursesButtonImg,
                                                 clickImg=base.submitAdminCoursesHoverButtonImg,
                                                 cursor="hand2", behavior=self.insertToDB)

        base.adminCoursesGroup = MyWidgetsGroup(base.Background, base.adminCoursesClassText,
                                                base.moduleAdminCoursesEntry, base.moduleAdminCoursesText,
                                                base.adminCoursesTypeText, base.adminCoursesClassLabel,
