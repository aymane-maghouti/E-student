...
class StudentHome:
    ...
    def createStudentHome(self, base):
        ...
        base.logoStudentObject = MyButton(base.Background, 79, 51, base.logoStudentImg, cursor="hand2",
                                          behavior=lambda: self.toStudentHome())

        base.studentHomeNewsImg = ImageTk.PhotoImage(Image.open(
            base.resourcePath("assets/studentHomePage/newsBackground.png")))

        base.studentHomeNewsFrame = MyScrollableFrame(base.Background, base.studentHomeNewsImg, "#1f1a24", 210, 320,
                                                      615, 107, 10, 50)
        base.studentHomeNewsText = base.Background.create_text(635, 117, font=("Montserrat", 20, "bold"), fill="white",
        ...
        base.studentHomeGraphFrame = MyFrame(base.Background, base.studentHomeGraphImg, "#1f1a24", 300, 200, 117, 244,
                                             10, 10)
        self.show_graph()
        ...
        base.studentMenuExtendedFrame = MyFrame(base.Background, base.studentMenuExtendedImg, "#1f1a24", 187, 351, 55,
                                                107, 4, 23)
        ...
        base.studentMenuIconButton = MyButton(base.studentMenuExtendedFrame.mainFrame, 0, 0,
                                              base.studentMenuExtendedIconImg, cursor="hand2", behavior=self.shrinkMenu)

        base.studentBooksExtendedIconImg = Image.open(
            base.resourcePath("assets/general/booksExtended.png"))

        base.studentBooksExtendedIconButton = MyButton(base.studentMenuExtendedFrame.mainFrame, 0, 57,
                                                       base.studentBooksExtendedIconImg, cursor="hand2",
        ...
        base.studentTimetableExtendedIconButton = MyButton(base.studentMenuExtendedFrame.mainFrame, 0, 107,
                                                           base.studentTimetableExtendedIconImg, cursor="hand2",
                                                           behavior=self.toTimeTable)

        base.studentGradesExtendedIconImg = Image.open(
            base.resourcePath("assets/general/GradesExtended.png"))

        base.studentGradesExtendedIconButton = MyButton(base.studentMenuExtendedFrame.mainFrame, 0, 156,
                                                        base.studentGradesExtendedIconImg, cursor="hand2",
                                                        behavior=self.toGrades)

        base.studentStaffExtendedIconImg = Image.open(
            base.resourcePath("assets/general/staffExtended.png"))

        base.studentStaffExtendedIconButton = MyButton(base.studentMenuExtendedFrame.mainFrame, 0, 207,
                                                       base.studentStaffExtendedIconImg, cursor="hand2",
                                                       behavior=self.toStaff)

        base.studentProfileExtendedIconImg = Image.open(
            base.resourcePath("assets/general/profileExtended.png"))

        base.studentProfileExtendedIconButton = MyButton(base.studentMenuExtendedFrame.mainFrame, 0, 256,
                                                         base.studentProfileExtendedIconImg, cursor="hand2",
                                                         behavior=self.toProfile)

        base.studentAboutExtendedIconImg = Image.open(
            base.resourcePath("assets/general/aboutExtended.png"))

        base.studentAboutExtendedIconButton = MyButton(base.studentMenuExtendedFrame.mainFrame, 0, 311,
                                                       base.studentAboutExtendedIconImg, cursor="hand2",
                                                       behavior=self.toAbout)

        base.studentHomeGroup = MyWidgetsGroup(base.Background, base.logoutStudentButton, base.studentHomeNewsText,
                                               base.studentHomeGraphFrame, base.studentHomeNewsFrame,
                                               base.studentHomeTitle)
        base.studentHomeInterfaceGroup = MyWidgetsGroup(base.Background, base.logoStudentObject,
                                                        base.logoutStudentButton, base.studentHomeNewsText,
                                                        base.studentHomeGraphFrame, base.studentHomeNewsFrame,
                                                        base.studentHomeTitle, base.studentHomeMenuFrame)
