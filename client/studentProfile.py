...
class StudentProfile:
    ...
    def createStudentProfile(self, base):
        ...
        full_name_label = Label(base.studentProfileFrame.scrollable_frame, text="Full Name :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=60,height=0,anchor=W)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        full_name_label.grid(row=1, column=0, padx=5,sticky=W)
        full_name_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[0][0]} {l[0][1]}",font=("Montserrat", 8, "bold"),
        ...
        CIN_label =  Label(base.studentProfileFrame.scrollable_frame, text="CIN :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        CIN_label.grid(row=3, column=0, padx=5, sticky=W)
        CIN_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[0][2]}",font=("Montserrat", 8, "bold"),
        ...
        CNE_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[0][3]}",font=("Montserrat", 8, "bold"),
        ...
        gender_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[0][4]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        gender_display.grid(row=8, column=0, padx=5)

        birthday_label = Label(base.studentProfileFrame.scrollable_frame,text="Birthday :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        birthday_label.grid(row=9, column=0, padx=5, sticky=W)
        birthday_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[0][5][0]} / {l[0][5][1]} / {l[0][5][2]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        birthday_display.grid(row=10, column=0,columnspan=2, padx=5)

        bac_sector_label = Label(base.studentProfileFrame.scrollable_frame,text="Bac Sector :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        bac_sector_label.grid(row=11, column=0, padx=5, sticky=W)
        bac_sector_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[2][1]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        bac_sector_display.grid(row=12, column=0,columnspan=2, padx=5)

        bac_language_label = Label(base.studentProfileFrame.scrollable_frame,text="Bac language :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        bac_language_label.grid(row=11, column=0, padx=5, sticky=W)
        bac_language_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[2][2]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        bac_language_display.grid(row=12, column=0,columnspan=2, padx=5)

        bac_grade_label = Label(base.studentProfileFrame.scrollable_frame,text="Bac grade :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        bac_grade_label.grid(row=13, column=0, padx=5, sticky=W)
        bac_grade_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[2][3]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        bac_grade_display.grid(row=14, column=0,columnspan=2, padx=5)

        bac_city_label = Label(base.studentProfileFrame.scrollable_frame,text="Bac city :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        bac_city_label.grid(row=15, column=0, padx=5, sticky=W)
        bac_city_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[2][0]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        bac_city_display.grid(row=16, column=0,columnspan=2, padx=5)

        high_school_name_label = Label(base.studentProfileFrame.scrollable_frame,text="High school name :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        high_school_name_label.grid(row=17, column=0, padx=5, sticky=W)
        high_school_name_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[2][4]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)

        high_school_name_display.grid(row=18, column=0,columnspan=2, padx=5)

        high_school_type_label = Label(base.studentProfileFrame.scrollable_frame,text="High school type :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        high_school_type_label.grid(row=19, column=0, padx=5, sticky=W)
        high_school_type_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[2][5]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        high_school_type_display.grid(row=20, column=0,columnspan=2, padx=5)

        address1_label = Label(base.studentProfileFrame.scrollable_frame,text="Address line 1 :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        address1_label.grid(row=21, column=0, padx=5, sticky=W)
        address1_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[3][0]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        address1_display.grid(row=22, column=0,columnspan=2, padx=5)

        address2_label = Label(base.studentProfileFrame.scrollable_frame,text="Address line 2 :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        address2_label.grid(row=23, column=0, padx=5, sticky=W)
        address2_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[3][1]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        ...
        city_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[3][4]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        city_display.grid(row=26, column=0,columnspan=2, padx=5)

        country_label = Label(base.studentProfileFrame.scrollable_frame,text="Country :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        country_label.grid(row=27, column=0, padx=5, sticky=W)
        country_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[3][5]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        country_display.grid(row=28, column=0,columnspan=2, padx=5)

        postal_code_label = Label(base.studentProfileFrame.scrollable_frame,text="Postal code :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        postal_code_label.grid(row=29, column=0, padx=5, sticky=W)
        postal_code_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[3][2]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        postal_code_display.grid(row=30, column=0,columnspan=2, padx=5)

        phone_number_label = Label(base.studentProfileFrame.scrollable_frame,text="Phone number :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        phone_number_label.grid(row=31, column=0, padx=5, sticky=W)
        phone_number_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[3][3]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        phone_number_display.grid(row=32, column=0,columnspan=2, padx=5)

        email_label = Label(base.studentProfileFrame.scrollable_frame,text="Email address :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        email_label.grid(row=33, column=0, padx=5, sticky=W)
        email_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[4][0]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        email_display.grid(row=34, column=0,columnspan=2, padx=5)

        filiere_label = Label(base.studentProfileFrame.scrollable_frame,text="Filiere :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=50,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        filiere_label.grid(row=35, column=0, padx=5, sticky=W)
        filiere_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[5][1]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        ...
        class_display = Label(base.studentProfileFrame.scrollable_frame, text=f"{l[5][0]}",font=("Montserrat", 8, "bold"),
                                                                 fg="white",bg="#1f1a24",width=60)
        ...
        profile_label = Label(base.studentProfileFrame.scrollable_frame, text="Profile photo :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=20,height=0,anchor=W)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
