...
class StudentProfile:
    ...
    def createStudentProfile(self, base):
        ...
        full_name_label = Label(base.studentProfileFrame.scrollable_frame, text="Full Name :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=30,height=0,anchor=W)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        ...
        CIN_label =  Label(base.studentProfileFrame.scrollable_frame, text="CIN :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",width=20,height=0,anchor=W,pady=0)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")
        ...
        profile_label = Label(base.studentProfileFrame.scrollable_frame, text="Profile photo :",font=("Montserrat", 8, "bold"),
                                                                 fg="#bb86fc",bg="#1f1a24",height=0,anchor=W)        # age_label = Label(base.studentProfileFrame.scrollable_frame, text="Age :")

        profile_label.grid(row=1, column=1,padx=0,pady=0, sticky=W)

        # Create Label widget and assign image to it
        image_label = Label(base.studentProfileFrame.scrollable_frame, bg="#1f1a24", anchor=W)
        ...
        base.studentProfileFrame.scrollable_frame.create_image(100,100,image=ImageTk.PhotoImage(emptyImg))
