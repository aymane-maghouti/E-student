...
class AdminNews:
    ...
    def createAdminNews(self, base):
        ...
        base.titreAdminNewsStandardObject.validate = lambda: checkLenght(base.titreAdminNewsStandardObject, 150,
                                                                         "Title")
        ...
        base.adminNewsClassList = MyMenu(base.Background, 250, 410, base.adminNewsClassLabel,
                                         ...
                                         base.menuAdminNewsClassMidClickedImg,
                                         base.menuListAdminNewsClassMidStandardImg,
        ...
        base.adminNewsForm = MyForm(base, base.titreAdminNewsStandardObject, base.detailAdminNewsEntry,
                                    base.adminNewsClassList)
        ...
        base.submitAdminNewsButton = MyButton(base.Background, 350, 431, standardImg=base.submitAdminNewsButtonImg,
                                              clickImg=base.submitAdminNewsHoverButtonImg,
