...
class StudentNewsDetail:
    ...
    def createStudentNewsDetail(self, base,notifications,i):
        ...
        #Time
        base.studentNewsTimeText=Label(base.studentNewsDetailFrame.scrollable_frame,text="Published :" ,font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="#bb86fc", background="#1f1a24")
        base.studentNewsTimeText.grid(row=1,column=0,sticky=W)
        base.studentNewsTime=Label(base.studentNewsDetailFrame.scrollable_frame,text=notifications[i][1], font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="white", background="#1f1a24")
        base.studentNewsTime.grid(row=2,column=0,sticky=W)

        #Title
        base.studentNewsTitleText=Label(base.studentNewsDetailFrame.scrollable_frame,text="Title :", font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="#bb86fc", background="#1f1a24")
        ...
        base.title = Text(base.studentNewsDetailFrame.scrollable_frame, width=title_width, height=num_lines, takefocus=False, font=("Montserrat", 10, "bold"),
                    relief="flat",foreground="white", background="#1f1a24")
        base.title.insert(tk.END,f"{notifications[i][0]}")
        base.title.grid(row=4,column=0,sticky=W)

        #Details
        base.studentNewsDetailsText=Label(base.studentNewsDetailFrame.scrollable_frame,text="Details :", font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="#bb86fc", background="#1f1a24")
        ...
        base.details = Text(base.studentNewsDetailFrame.scrollable_frame, width=details_width, height=num_lines, takefocus=False, font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="white", background="#1f1a24")
        ...
        base.studentNewsDetailGroup=MyWidgetsGroup(base.Background,base.studentNewsDetailTitle,base.studentNewsDetailFrame)
