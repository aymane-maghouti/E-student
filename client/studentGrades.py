...
class StudentGrades:
    ...
    def show_grades(self):
        ...
        Label(table_frame, text="Class", width=5, height=2,font=("Montserrat", 12, "bold"),foreground="#bb86fc",background="#1f1a24").grid(row=0, column=0)
        Label(table_frame, text="Module", width=30, height=2,font=("Montserrat", 12, "bold"),foreground="#bb86fc",background="#1f1a24").grid(row=0, column=1)
        Label(table_frame, text="Download", width=9, height=2,font=("Montserrat", 12, "bold"),foreground="#bb86fc",background="#1f1a24").grid(row=0, column=2)
        ...
        i=0
        for row in result:
            Label(table_frame, text=row[0], width=5, height=2,font=("Montserrat", 10),foreground="white",background="#1f1a24").grid(row=i + 1, column=0)
            Label(table_frame, text=row[1], width=30, height=2,font=("Montserrat", 10),foreground="white",background="#1f1a24").grid(row=i + 1, column=1)
            downloadButton=tk.Button(table_frame,relief="sunken",borderwidth=0,cursor="hand2",activebackground="#1f1a24",background="#1f1a24",image=self.downloadStandardIcon,command=lambda index=i:download_button_click(index))
            downloadButton.grid(row=i+1, column=2)
            Label(table_frame, text=row[3], width=15, height=2,font=("Montserrat", 10),foreground="white",background="#1f1a24").grid(row=i + 1, column=3)
            i+=1
