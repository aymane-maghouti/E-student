...
class AdminAdvancedSearch:
    ...
    def createAdminAdvancedSearch(self, base, student):
        ...
        base.adminAdvancedSearchFrame = MyScrollableFrame(base.Background, base.adminAdvancedSearchImg, "#1f1a24", 685,
                                                          297, 117, 174, 20, 20)
        ...
        base.adminAdvancedSearchGroup = MyWidgetsGroup(base.Background, base.adminAdvancedSearchTitle,
                                                       base.adminAdvancedSearchFrame)
