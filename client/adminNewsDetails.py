...
class AdminNewsDetail:
    ...
    def createAdminNewsDetail(self, base,notifications,i):
        ...
        base.adminNewsDetailImg =ImageTk.PhotoImage(Image.open(
           base.resourcePath("assest/adminNewsDetailPage/newsDetailBackground.png")))

        base.adminNewsDetailFrame=MyScrollableFrame(base.Background,base.adminNewsDetailImg,"#1f1a24",685,297,117,174,20,20)


        #Time
        base.adminNewsTimeText=Label(base.adminNewsDetailFrame.scrollable_frame,text="Published :" ,font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="#bb86fc", background="#1f1a24")
        base.adminNewsTimeText.grid(row=1,column=0,sticky=W)
        base.adminNewsTime=Label(base.adminNewsDetailFrame.scrollable_frame,text=notifications[i][1], font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="white", background="#1f1a24")
        base.adminNewsTime.grid(row=2,column=0,sticky=W)

        #Title
        base.adminNewsTitleText=Label(base.adminNewsDetailFrame.scrollable_frame,text="Title :", font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="#bb86fc", background="#1f1a24")
        ...
        base.title = Text(base.adminNewsDetailFrame.scrollable_frame, width=title_width, height=num_lines, takefocus=False, font=("Montserrat", 10, "bold"),
                    relief="flat",foreground="white", background="#1f1a24")
        base.title.insert(tk.END,f"{notifications[i][0]}")
        base.title.grid(row=4,column=0,sticky=W)

        #Details
        base.adminNewsDetailsText=Label(base.adminNewsDetailFrame.scrollable_frame,text="Details :", font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="#bb86fc", background="#1f1a24")
        ...
        base.details = Text(base.adminNewsDetailFrame.scrollable_frame, width=details_width, height=num_lines, takefocus=False, font=("Montserrat", 10, "bold"),
                    relief="flat", foreground="white", background="#1f1a24")
        ...
        base.adminNewsDetailGroup=MyWidgetsGroup(base.Background,base.adminNewsDetailTitle,base.adminNewsDetailFrame)
