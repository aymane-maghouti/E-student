...
class Register6:
    ...
    def createRegister6(self, base):
        ...
        registerInfo = MyScrollableFrame(base.Background, base.register6BackgroundWidgetsImg, "#1f1a24", 315, 159, 95,
                                         255, 14, 15)
        l = base.getRegisterValues()

        full_name_label = Label(registerInfo.scrollable_frame, text="Full Name :", font=("Montserrat", 8, "bold"),
                                fg="#bb86fc", bg="#1f1a24", width=30, height=0,
                                anchor=W)  # age_label = Label(registerInfo.scrollable_frame, text="Age :")
        full_name_label.grid(row=1, column=0, padx=5, sticky=W)
        full_name_display = Label(registerInfo.scrollable_frame, text=f"{l[0][0]} {l[0][1]}",
        ...
        CIN_label = Label(registerInfo.scrollable_frame, text="CIN :", font=("Montserrat", 8, "bold"),
                          fg="#bb86fc", bg="#1f1a24", width=20, height=0, anchor=W,
                          pady=0)  # age_label = Label(registerInfo.scrollable_frame, text="Age :")
        ...
        birthday_display = Label(registerInfo.scrollable_frame, text=f"{l[0][5][0]} / {l[0][5][1]} / {l[0][5][2]}",
                                 font=("Montserrat", 8, "bold"),
                                 fg="white", bg="#1f1a24", width=30)
        ...
        high_school_name_label = Label(registerInfo.scrollable_frame, text="High school name :",
                                       font=("Montserrat", 8, "bold"),
                                       fg="#bb86fc", bg="#1f1a24", width=20, height=0, anchor=W,
                                       pady=0)  # age_label = Label(registerInfo.scrollable_frame, text="Age :")
        high_school_name_label.grid(row=17, column=0, padx=5, sticky=W)
        high_school_name_display = Label(registerInfo.scrollable_frame, text=f"{l[2][4]}",
                                         font=("Montserrat", 8, "bold"),
                                         fg="white", bg="#1f1a24", width=30)

        high_school_name_display.grid(row=18, column=0, columnspan=2, padx=5)

        high_school_type_label = Label(registerInfo.scrollable_frame, text="High school type :",
                                       font=("Montserrat", 8, "bold"),
                                       fg="#bb86fc", bg="#1f1a24", width=20, height=0, anchor=W,
                                       pady=0)  # age_label = Label(registerInfo.scrollable_frame, text="Age :")
        high_school_type_label.grid(row=19, column=0, padx=5, sticky=W)
        high_school_type_display = Label(registerInfo.scrollable_frame, text=f"{l[2][5]}",
                                         font=("Montserrat", 8, "bold"),
                                         fg="white", bg="#1f1a24", width=30)
        ...
        base.submitRegister6Button = MyButton(base.Background, 221, 453, standardImg=base.submitRegister6ButtonImg,
                                              cursor="hand2",
                                              behavior=lambda: self.submit(base.getRegisterValues(), base))
        ...
        base.register6Group = MyWidgetsGroup(base.Background, registerInfo, base.register6WidgetsFrame,
                                             base.register6Title, base.confirmChoicesText, base.submitRegister6Button)
