...
class AdminAbout:
    ...
    def createAdminAbout(self, base):
        ...
        base.adminAboutFrame = MyScrollableFrame(base.Background, base.adminAboutImg, "#1f1a24", 685, 297, 117, 174, 20,
                                                 20)

        # Technical
        base.adminAboutTechnicalText = Label(base.adminAboutFrame.scrollable_frame, text="Technical Informations :",
        ...
        base.Technical = Text(base.adminAboutFrame.scrollable_frame, width=Technical_width, height=num_lines,
        ...
        # materials
        base.adminMaterialsText = Label(base.adminAboutFrame.scrollable_frame, text="About Materials :",
                                        font=("Montserrat", 10, "bold"),
                                        relief="flat", foreground="#bb86fc", background="#1f1a24")
        ...
        base.Materials = Text(base.adminAboutFrame.scrollable_frame, width=Materials_width, height=num_lines,
                              takefocus=False, font=("Montserrat", 10, "bold"),
                              relief="flat", foreground="white", background="#1f1a24")
        ...
        # developers
        base.admindevelopersText = Label(base.adminAboutFrame.scrollable_frame, text="About Developers :",
                                         font=("Montserrat", 10, "bold"),
                                         relief="flat", foreground="#bb86fc", background="#1f1a24")
        ...
        base.developers = Text(base.adminAboutFrame.scrollable_frame, width=developers_width, height=num_lines,
                               takefocus=False, font=("Montserrat", 10, "bold"),
                               relief="flat", foreground="white", background="#1f1a24")
        ...
        base.App = Text(base.adminAboutFrame.scrollable_frame, width=App_width, height=num_lines, takefocus=False,
                        font=("Montserrat", 10, "bold"),
                        relief="flat", foreground="white", background="#1f1a24")
