...
import os
from backEndUtilities import save_into_affichage,update_student
...
class AdminUpdate:
    ...
    def createAdminUpdate(self, base,student):
        ...
        base.adminUpdateFiliereList = MyMenu(base.Background, 250, 289, base.adminUpdateFiliereLabel,
                                            base.menuAdminUpdateClassMidStandardlImg, base.menuAdminUpdateClassMidHoverImg,
                                            base.menuAdminUpdateClassMidClickedImg, base.menuListAdminUpdateClassMidStandardImg,
        ...
        base.adminUpdateGroup=MyWidgetsGroup(base.Background,base.adminUpdateClassList,base.adminUpdateClassLabel,base.adminUpdateClassText,base.adminUpdateFiliereList,base.adminUpdateFiliereLabel,base.adminUpdateFiliereText,base.adminUpdateTitle,base.adminUpdateFrame)
